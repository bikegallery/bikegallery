...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields =  array(
		'author' => '<p class="comment-form-author">' . '<label for="author">' . __( '' ) . '</label> ' . ( $req ? '' : '' ) .
		            '<input id="author" name="author" type="text" value="Name"' . $aria_req . ' /></p>',
		'email'  => '<p class="comment-form-email"><label for="email">' . __( '' ) . '</label> ' . ( $req ? '' : '' ) .
		            '<input id="email" name="email" type="text" value="Email"' . $aria_req . ' /></p>',
		'url'    => '<p class="comment-form-url"><label for="url">' . __( '' ) . '</label>' .
		            '<input id="url" name="url" type="text" value="Website" /></p>',
	);
