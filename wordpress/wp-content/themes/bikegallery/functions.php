...
function twentyten_widgets_init() {
	...
	// Area 3, located in the first grid of the footer
	register_sidebar( array(
	...
	// Area 4, located in the second grid of the footer
	register_sidebar( array(
	...
	// Area 5, located in the third grid of the footer
	register_sidebar( array(
	...
	// Area 6, located in the fourth grid of the footer
	register_sidebar( array(
	...
	// Area 7, located in the fifth grid of the footer
	register_sidebar( array(
...
function twentyten_posted_in() {
	...
	if ( $tag_list ) {
		$posted_in = __( 'This entry was posted in %1$s and tagged %2$s. <a href="%3$s" title="Permalink to %4$s" rel="bookmark">Permalink</a>.', 'twentyten' );
	} elseif ( is_object_in_taxonomy( get_post_type(), 'category' ) ) {
		$posted_in = __( 'This entry was posted in %1$s. <a href="%3$s" title="Permalink to %4$s" rel="bookmark">Permalink</a>.', 'twentyten' );
	} else {
		$posted_in = __( '<a href="%3$s" title="Permalink to %4$s" rel="bookmark">Permalink</a>.', 'twentyten' );
	}
