<div id="wpbody-content" style="overflow: hidden;">
    ...
    <div class="wrap">
        ...
        <h2>Events Planner Help Section <?php echo get_help_icon( array( 'section' => 'help' ) ); ?></h2>
        <?php echo epl_show_ad( 'Go Pro, get priority help, more tools, discounts on custom development, and more.' ); ?>
        ...
        <div class="epl_box">
            <div class="epl_box_content">
                ...
                <ol>
                    <li>
                        Every place you see this icon <?php echo '<img  src ="' . EPL_FULL_URL . 'images/email.png" alt="Send Feedback" />'; ?>, please click on it to send a feedback straight from this install of wordpress (if of course you can send emails out of this install).
                    </li>
                    <li>
                        Every place you see this icon <?php echo '<img  src ="' . EPL_FULL_URL . 'images/help.png" alt="Send Feedback" />'; ?>,
