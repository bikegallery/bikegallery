...
<table class="form-table">
	...
	<tr>
		...
		<td class="slider">
			<input type="text" name="auto-thickbox-plus[click_range]" value="<?php echo $this->options['click_range']; ?>" id="click-range" class="small-text"<?php $this->util->disabled($click_range_disabled); ?> />
			<span>%</span>
	...
	<tr>
		<th scope="row"><?php $this->util->_e('Mouse Wheel'); ?> (<?php $this->util->_e('Scroll'); ?>)</th>
		<th scope="row"><?php echo $this->texts['image']; ?></th>
		<td>
			...
			<?php $this->util->_e('Scale'); ?> (<?php $this->util->_e('beta'); ?>)</label>
...
<table class="form-table">
	...
	<tr>
		...
		<td>
			...
			<input type="text" name="auto-thickbox-plus[win_width]" value="<?php echo $this->options['win_width']; ?>" class="small-text" /> px</label>
			<label class="item boundary"><?php $this->util->_e('Height'); ?>
			<input type="text" name="auto-thickbox-plus[win_height]" value="<?php echo $this->options['win_height']; ?>" class="small-text" /> px</label>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<th scope="row"><?php $this->util->_e('Window'); ?></th>
		<td>
			<input type="text" name="auto-thickbox-plus[border_width_win]" value="<?php echo $this->options['border_width_win']; ?>" class="small-text"<?php $this->util->disabled($border_win_none); ?> /> px
	...
	<tr>
		...
		<td>
			<input type="text" name="auto-thickbox-plus[border_width_img_tl]" value="<?php echo $this->options['border_width_img_tl']; ?>" class="small-text"<?php $this->util->disabled($border_img_tl_none); ?> /> px
	...
	<tr>
		...
		<td>
			<input type="text" name="auto-thickbox-plus[border_width_img_br]" value="<?php echo $this->options['border_width_img_br']; ?>" class="small-text"<?php $this->util->disabled($border_img_br_none); ?> /> px
	...
	<tr>
		...
		<td>
			<input type="text" name="auto-thickbox-plus[border_width_gallery]" value="<?php echo $this->options['border_width_gallery']; ?>" class="small-text"<?php $this->util->disabled($border_gallery_none); ?> /> px
...
<table class="form-table">
	<tr>
		<th scope="row"><?php echo ucfirst($this->util->_s('Open', 'open')); ?></th>
		<td>
	...
	<tr>
		...
		<td>
			...
			<label class="item"><input type="radio" name="auto-thickbox-plus[effect_speed]" value="number"<?php $this->util->checked($effect_speed_num); ?> onclick="updateEffectSpeed(this)" />
				<input type="text" name="auto-thickbox-plus[effect_speed]" value="<?php echo $effect_speed; ?>"<?php $this->util->disabled(!$effect_speed_num); ?> class="small-text" /> ms</label>
		</td>
	</tr>
</table>
<?php
