...
{
	display: inline-block;overflow: hidden; position: relative; padding:0px;margin:0 0 10px 0; text-align:center; width:<?php echo $total_width;?>px !important;
...
#wpcontent_slider .cs-title {padding: 10px; background: <?php echo $wpcs_settings['background_color']; ?>; color: <?php echo $wpcs_settings['color']; ?>; font-family: <?php echo stripslashes($wpcs_settings['font_family']); ?>; font-size: <?php echo $wpcs_settings['font_size']; ?>px; letter-spacing: normal;line-height: normal;}
