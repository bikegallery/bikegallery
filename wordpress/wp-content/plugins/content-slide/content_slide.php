...
#wpcontent_slider {
	border: <?php echo $wpcs_settings['border_width'];?>px solid <?php echo $wpcs_settings['border_color'];?>;
	font-family: <?php echo $wpcs_settings['font_family'];?>;
	overflow: hidden;
	position: relative;
	text-align: left;
}
...
#wpcontent_slider .cs-title {
	background: <?php echo $wpcs_settings['background_color']; ?>;
	color: <?php echo $wpcs_settings['color']; ?>;
	font-family: <?php echo stripslashes($wpcs_settings['font_family']); ?>;
	font-size: <?php echo $wpcs_settings['font_size']; ?>px;
...
#wpcontent_slider_container .cs-buttons a {
	border: 1px solid <?php echo $wpcs_settings['navigation_color'];?>;
	color: <?php echo $wpcs_settings['navigation_color'];?>;
	float: left;
	height: 10px;
	margin-left: 5px;
	outline: none;
...
#wpcontent_slider_container .cs-active {
	background-color: <?php echo $wpcs_settings['navigation_color'];?>;
	color: #fff;
}
